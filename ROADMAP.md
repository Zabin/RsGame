...
| ID | Document | Path | Depends on | Status |
|---|---|---|---|---|
| FS-101+ | One spec per approved Feature | `docs/features/FS-xxx-*.md` | FP catalog, RQ baseline | 🚧 (FS-101 ✅ shipped/VERIFIED 2026-07-07; FS-102/103/104/105 ✅ 2026-07-10, FEAT-9000/4100/1100/5300, not yet implemented — 7 Open Questions total routed to `07`; one more Release-2 Feature (FEAT-6100) remains unspecified) |
