...
> FR-1200/FR-1210 added once GDS-01 §4c/GDS-08 §11 landed, `CR-06` resolved/baselined).**
...
| FR-1200 | SELECT MENU state (target, supersedes FR-1150's SELECT→MAP clause) | — | GDS-01 §4c | — | `asm_game.py`, `tilemaps.py` (prospective) | UNASSIGNED | UNASSIGNED | UNASSIGNED |
| FR-1210 | LEGEND state (target) | — | GDS-08 §11 | — | `asm_game.py`, `tilemaps.py` (prospective) | UNASSIGNED | UNASSIGNED | UNASSIGNED |
