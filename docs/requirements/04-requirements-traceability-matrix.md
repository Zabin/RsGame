...
| FR-1170 | MAIN MENU state (Met, 2026-07-10) | — | GDS-01 §2a/§4a | ADR-0010 | `asm_game.py` | FS-104 | IP-1040 | T14.a1–a4 — 163/163 pass |
| FR-1180 | New-game seed/scale entry + generation trigger (Met) | R111 | GDS-01 §4a | ADR-0009, ADR-0010 | `asm_game.py` | FS-104 | IP-1040 | T14.b1–b3, T14.c1 — 163/163 pass |
| FR-1190 | Exit-to-main-menu with auto-save (Met) | — | GDS-01 §4a | — | `asm_game.py` | FS-104 | IP-1040 | T14.d1–d2 — 163/163 pass |
...
| FR-4300 | One biome per screen (code half Met, `IP-1030`; content half awaits `IP-1031`) | R212 | GDS-08 delta §8 | ADR-0009 | `asm_game.py`, `tilemaps.py` | FS-103 | IP-1030 (code), IP-1031 (content) | T13.a (tile-family audit, code half) — 136/136 pass |
...
| FR-9100 | Deterministic world generation from (seed, scale) | R111, R213 | GDS-04 delta; ADR-0009 | ADR-0009 | `asm_game.py`, `worldgen.py` | FS-102 | IP-1020 | T12.a (two-boot determinism), T12.b (oracle parity), T12.e (region count) |
