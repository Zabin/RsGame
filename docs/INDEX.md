...
|---|---|---|
| [`pipeline/`](pipeline/BOOTSTRAP.md) | The run-book ([BOOTSTRAP.md](pipeline/BOOTSTRAP.md)), the manager's journal ([pipeline-journal.md](pipeline/pipeline-journal.md)) and backlog ([backlog.md](pipeline/backlog.md)) | `00-pipeline-manager`, `00-intake` |
