...
| Release assessment | Release 2 bundled with all post-ship work (7 Features + 15 remediation packages) | 2026-07-12 | **GO recommended (advisory)** — pending user's explicit decision; 1 named deviation (`FEAT-2100` rendering half undelivered, `BL-0075` open) | [release-assessment-release-2-bundled.md](release-assessment-release-2-bundled.md) |
