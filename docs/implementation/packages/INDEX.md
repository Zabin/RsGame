...
|---|---|---|---|---|
| [IP-9010](IP-9010-test-suite-rewrite.md) | Test suite rewrite (Bunny Quest semantics + portable paths) | BL-0006 + BL-0005 (BL-0008 umbrella) | COMPLETE | Implemented 2026-07-07 (109/109 pass, ROM byte-identical); awaiting 09-package-verification. |
...
| [IP-9030](IP-9030-root-doc-refresh.md) | Root documentation refresh | BL-0007 (BL-0008 umbrella) | BLOCKED | Authorized (user G3 2026-07-07, BL-0024); depends on IP-9010 + IP-9020. |
...
| [IP-1010](IP-1010-per-zone-scoreitem-persistence.md) | Per-zone ScoreItem persistence | FS-101 / FEAT-5100 (+ BL-0023 rider) | BLOCKED | Authorized (user G3 2026-07-07, BL-0024); depends on IP-9010. Release 1's sole Feature. |
