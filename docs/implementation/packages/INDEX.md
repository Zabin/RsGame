...
| [IP-1031](IP-1031-generated-region-screen-composition-content.md) | Generated-region screen composition — content | FS-103 / FEAT-4100 | **READY** | Authorized 2026-07-10 (`BL-0040`). Registers 5 existing shipped screen functions as biome-family representatives — zero new art. Depends on IP-1020 (VERIFIED), IP-1030 (VERIFIED). |
