...
| [IP-9020](IP-9020-score-bar-vblank-fix.md) | Score-bar VRAM write timing fix | BL-0003 (BL-0008 umbrella) | **READY** | Authorized (carve-out); depends on IP-9010 (VERIFIED). |
| [IP-9030](IP-9030-root-doc-refresh.md) | Root documentation refresh | BL-0007 (BL-0008 umbrella) | BLOCKED | Authorized (user G3 2026-07-07, BL-0024); depends on IP-9010 (VERIFIED) + IP-9020 (READY, not yet VERIFIED). |
| [IP-9040](IP-9040-legacy-artifact-archival.md) | Legacy artifact archival | BL-0004 (BL-0008 umbrella) | **READY** | Authorized (carve-out + user decision run #1); depends on IP-9010 (VERIFIED). |
