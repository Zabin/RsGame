...
| [IP-1040](IP-1040-main-menu-new-game-flow.md) | Main menu & new-game flow | FS-104 / FEAT-1100 | **COMPLETE — 163/163 checks pass** | Authorized 2026-07-10 (`BL-0040`). Resolves FS-104 OQ1–2. Retires the auto-load bypass. Depends on IP-1020 (VERIFIED). Awaiting independent verification. |
| [IP-1050](IP-1050-generated-world-save-persistence.md) | Generated-world save persistence | FS-105 / FEAT-5300 | **COMPLETE — 180/180 checks pass** | Authorized 2026-07-10 (`BL-0040`). Second save-format version bump (`0x01`→`0x02`), extending IP-1010's pattern. Depends on IP-1020 (VERIFIED). Awaiting independent verification. |
