...
| [IP-1010](IP-1010-per-zone-scoreitem-persistence.md) | Per-zone ScoreItem persistence | FS-101 / FEAT-5100 (+ BL-0023 rider) | **COMPLETE** | Implemented 2026-07-07: `SCOREITEM_FLAGS`/version guard added; all 5 ACs verified by T11.a–e; 125/125 pass; ROM 23404/32768 bytes. Awaiting `09-package-verification`. Release 1's sole Feature. |
