...
`IP-1106` all `VERIFIED`; `IP-1111` `COMPLETE`, own `09-package-verification` pass owed; `IP-9160`/
`IP-9150` `COMPLETE`, each also owed its own `09-package-verification` pass — all six (plus the
two remediation packages) were authorized together ("Build all six," 2026-07-16; remediations
