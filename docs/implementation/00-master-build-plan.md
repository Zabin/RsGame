...
| [IP-1124](packages/IP-1124-infinite-mode-combat-save-persistence.md) | Infinite Mode Combat: Save Persistence | `08-code-implementation` | **NOT STARTED** | IP-1121 (VERIFIED), IP-1122, IP-1123 | **AUTHORIZED (G3, user "Yes, build all six," 2026-07-17)** | New SRAM `0xA350`–`0xA371`; `SAVE_VERSION_VAL` `0x05`→`0x06` (sixth bump since ship, extending `IP-1010`→`IP-1050`→`IP-9110`→`IP-1104`'s own monotonic sequence). Projectile deliberately not persisted, mirroring `INF_MZ_RESULT`'s own transient-state precedent. Last in critical path — still blocked on `IP-1122`/`IP-1123`. |
