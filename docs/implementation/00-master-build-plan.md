...
**Authorization state: all six packages AUTHORIZED** (G3, user "Yes, build all six," 2026-07-17).
Build order per the critical path above: `IP-1125` first (dependency root), then `IP-1121`, then
`IP-1122`/`IP-1123` (parallel-eligible), then `IP-1124` last; `IP-1120` in parallel once `IP-1121`
lands.
