...
| [IP-8090](packages/IP-8090-pipeline-journal-archive-split.md) | Pipeline Journal Archive Split (refactor, doc-scope) | `08-refactoring` | **IN PROGRESS** | none | **AUTHORIZED (user directly approved the "archive-split" approach via `AskUserQuestion`, 2026-07-20)** | Filed from `BL-0180` (user-directed: "Refactor all log and roadmap files"). Splits `docs/pipeline/pipeline-journal.md` (541KB, 285 run-log rows) into a live file (Position + recent runs) and a new archive file (older runs, verbatim). |
