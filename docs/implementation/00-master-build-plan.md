...
`VERIFIED`) → `IP-1022` (`COMPLETE`, own `09` pass owed) → `IP-1106` (`BLOCKED` on `IP-1022`).
...
**Authorization state (all six packages, current):** `IP-1105`/`IP-1033`/`IP-1110` all `VERIFIED`;
`IP-1022` `COMPLETE` (own `09` pass owed); `IP-1106`/`IP-1111` `BLOCKED`, both transitively on
`IP-1022`'s own verification, not on any authorization gap — all six were authorized together
("Build all six," 2026-07-16), so nothing in this tranche is currently gated on G3.
