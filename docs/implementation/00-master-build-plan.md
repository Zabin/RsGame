...
| [IP-9030](packages/IP-9030-root-doc-refresh.md) | Root documentation refresh (BL-0007) | `08-code-implementation` | **READY** | IP-9010 (VERIFIED), IP-9020 (VERIFIED) | **YES — explicit user G3, 2026-07-07 (BL-0024)** | Docs-only; both dependencies now VERIFIED (2026-07-07) — eligible for `08-code-implementation`. |
...
graph TD
    ...
    IP9030["IP-9030 root-doc refresh<br/>(READY)"]
...
- IP-9020 is `VERIFIED` (2026-07-07, [VR-9020](verification/VR-9020-score-bar-vblank-fix.md)) —
  `IP-9030`'s last blocking dependency; `IP-9030` is now `READY`.
...
- **Four of five packages VERIFIED** (IP-9010, IP-9020, IP-9040, IP-1010). The sole remaining
  package, `IP-9030` (root-doc refresh), is `READY` for `08-code-implementation` (docs-only,
  G3 already on record via BL-0024).
