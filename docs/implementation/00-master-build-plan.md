...
| [IP-8100](packages/IP-8100-backlog-archive-split.md) | Backlog Archive Split (refactor, doc-scope) | `08-refactoring` | **IN PROGRESS** | none | **AUTHORIZED (user directly approved the "archive-split" approach via `AskUserQuestion`, 2026-07-20)** | Filed from `BL-0181`. Splits `docs/pipeline/backlog.md` (377KB, ~182 entries, ~64% `DONE`) into a live file (open-status entries) and a new archive file (`DONE`/`REJECTED`, verbatim). |
