...
| Package | Title | Owner (08 peer) | Status | Depends on | Authorized? | Notes |
|---|---|---|---|---|---|---|
| [IP-1125](packages/IP-1125-combat-sprite-content.md) | Combat Sub-Mode: Mob & Projectile Sprite Content | `08-content-authoring` | **NOT STARTED** | None | **AUTHORIZED (G3, user "Yes, build all six," 2026-07-17)** | New tile indices `0x0A`–`0x0D` (mob top/bottom, projectile top/bottom), 8×16 OBJ per `ADR-0007`. No dependency on any combat logic package — every other package in this delta depends on it. |
