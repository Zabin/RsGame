...
| [IP-1030](packages/IP-1030-generated-region-screen-composition-code.md) | Generated-region screen composition — code (FS-103 / FEAT-4100) | `08-code-implementation` | **READY** | IP-1020 (VERIFIED) | **YES — explicit user G3, 2026-07-10 (BL-0040)** | `ALL_SCREENS` generalized to 5 biome-family entries; `_zone_arrows`' hardcoded rectangle math retired in favor of reading `REGION_GRAPH` neighbor data (ADR-0009 point 6). |
