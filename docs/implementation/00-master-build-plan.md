...
| [IP-8110](packages/IP-8110-roadmap-cell-compaction.md) | ROADMAP.md Cell Compaction (refactor, doc-scope) | `08-refactoring` | **IN PROGRESS** | none | **AUTHORIZED (user directly approved the "compact + pointer" approach via `AskUserQuestion`, 2026-07-20)** | Filed from `BL-0182`. Compacts ROADMAP.md's seven worst-offender Status cells (`IM-00` ~17.4KB down to a summary) to current-state + pointer to the owning doc, verified fact-by-fact before trimming. |
