...
and `IP-1123` (the latter still verification-owed) — `BLOCKED` until `IP-1123` reaches `VERIFIED`,
independent of `IP-1126`'s own status. Neither extends the original critical path (`IP-1124` does
