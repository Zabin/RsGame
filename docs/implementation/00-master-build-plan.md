...
| [IP-9020](packages/IP-9020-score-bar-vblank-fix.md) | Score-bar VRAM write timing fix (BL-0003) | `08-code-implementation` | **READY** | IP-9010 (VERIFIED) | **YES** — G3 bootstrap carve-out (BL-0003 ∈ BL-0001…0005) | Closes NFR-1200 NOT MET. Rider: BL-0019 headroom check. |
| [IP-9030](packages/IP-9030-root-doc-refresh.md) | Root documentation refresh (BL-0007) | `08-code-implementation` | BLOCKED | IP-9010 (VERIFIED), IP-9020 (READY, not yet VERIFIED) | **YES — explicit user G3, 2026-07-07 (BL-0024)** | Docs-only; must land after the fixes it documents. |
...
graph TD
    ...
    IP9020["IP-9020 score-bar VBlank fix<br/>(READY)"]
...
- **Now unblocked, in parallel:** IP-9020, IP-9040, and IP-1010 are all `READY` (independent
  files/concerns) — any may start next; IP-9030 stays `BLOCKED` until IP-9020 is also `VERIFIED`.
