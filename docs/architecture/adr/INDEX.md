...
| [ADR-0020](ADR-0020-procedural-screen-fill-for-rom-budget.md) | Runtime procedural background-fill + landmark-overlay rendering for the four newly-folded biome screens (Village/Cave/Desert/Plains), closing `IP-1022`'s ROM-budget gap (`BL-0134`) without triggering `ADR-0011`'s bank-switching cutover; the five original screens keep their existing baked-array format unchanged | Accepted | 2026-07-17 |
| [ADR-0021](ADR-0021-weapon-direction-representation.md) | Weapon-direction representation: a new `PLAYER_FACING` concept (not a widened `PLAYER_DIR`), 8-directional, diagonal projectile motion via simultaneous independent per-axis stepping (not vector math), no new player sprite art | Accepted | 2026-07-19 |
| [ADR-0022](ADR-0022-automatic-weapon-tier-funding-trigger.md) | Automatic weapon-tier funding trigger: threshold-crossing auto-spend each frame (10 treasure for tier 1→2, 25 total for tier 2→3), no button binding required, resolving `BL-0148`'s tier-spend half | Accepted | 2026-07-20 |
