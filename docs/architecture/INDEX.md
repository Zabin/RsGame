...
| GDS-07 | Data Model | [07-data-model.md](07-data-model.md) | ✅ Authored (gate closed 2026-07-06; delta 2026-07-09 for procgen-world increment — proposed WRAM/SRAM fields for seed/scale/region graph; delta 2026-07-12 — §7c per-region treasure-presence concept, `ADR-0015`; delta 2026-07-14 — §7d Infinite Mode per-region materialization WRAM, `IP-1101`) |
